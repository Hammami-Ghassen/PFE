...
const Header = ({ title }) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between shadow-sm">
      <h1 className="text-xl font-bold text-gray-900 min-w-[200px]">{title || 'HR & Leave Portal'}</h1>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <p className="text-sm font-medium text-gray-700 hidden sm:block">{displayName || 'Profile'}</p>
