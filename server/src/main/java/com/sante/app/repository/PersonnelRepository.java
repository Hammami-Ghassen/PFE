...
public interface PersonnelRepository extends JpaRepository<Personnel, String> {
       ...
       // Single-query profile projection reduces auth/profile hydration to one DB
       // roundtrip.
       @Query(value = """
                      SELECT p."MAT_PERS" AS matPers,
       ...
       List<Personnel> findContactsByCodSoc(@Param("codSoc") String codSoc,
                     @Param("currentMatPers") String currentMatPers);
